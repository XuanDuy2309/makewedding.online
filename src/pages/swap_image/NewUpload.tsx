...
const NewUpload = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.funface.online/images/${user.id_user}?type=video`,
        {
          headers: {
  ...
  const handleGenerate = async () => {
    ...
    if (original_Image_1) {
      ...
      req_post_img_1 = axios
        .post(
          `https://api.funface.online/upload-gensk/${userData.id_user}?type=src_nam`,
          image_1_formData,
          {
            headers: {
    ...
    if (original_Image_2) {
      ...
      req_post_img_2 = axios
        .post(
          `https://api.funface.online/upload-gensk/${userData.id_user}?type=src_nu`,
          image_2_formData,
          {
            headers: {
              "Content-Type": "multipart/form-data",
    ...
    if (src_res_1 != null && src_res_2 != null) {
      try {
        ...
        const response = await axios.get(
          `https://video.funface.online/getdata/swap/listimage_wedding?device_them_su_kien=${
